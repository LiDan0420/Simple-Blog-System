...
<head>
    ...
    <link rel="shortcut icon" href="<%=basePath%>assets/images/logo.jpg">
    <title>博客系统</title>
...
<section id="container">
    ...
    <header class="header black-bg">
        <div class="sidebar-toggle-box">
            <div class="fa fa-bars tooltips" data-placement="right" data-original-title="Toggle Navigation">
                <img src="assets/images/logo.jpg" height="30px" width="30px">
            </div>
        </div>
        <!--logo start-->
        <a href="#" class="logo"><b>博客系统</b></a>
        <!--logo end-->
    ...
    <aside>
        <div id="sidebar" class="nav-collapse scrollable">
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li>
                    <img src="<%=basePath%>assets/images/touxiang1.jpg" height="180px" width="180px">
    ...
    *********************************************************************************************************************************************************** -->
    ...
    <footer class="footer">
        <p class="pull-left"></p>
        <p class="pull-right">&copy; What We Say are All Right 2017</p>
    </footer>
    <!--footer end-->
</section>
